...
255. ultralytics/cfg/models/11/yolo11-C3k2-ELGCACGLU.yaml
    ...
    使用[ELGC-Net](https://github.com/techmn/elgcnet)中的ELGCA和和[TransNeXt CVPR2024](https://github.com/DaiShiResearch/TransNeXt)中的Convolutional GLU改进C3k2.(需要看[常见错误和解决方案的第五点](#a))
    项目视频百度云链接:20250205版本更新说明
